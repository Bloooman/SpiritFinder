...
class DionswineComScraper(StoreScraper):
    name = "Dion's Fine Wine, Craft Beer, Spirits, MA"
    _base = 'http://www.dionswine.com'
    _search_url = 'https://dionswine.com/shop?ch-query={query}'
