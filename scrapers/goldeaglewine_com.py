...
class GoldeaglewineComScraper(StoreScraper):
    name = 'Gold Eagle Wine and Spirits, IL'
    _base = 'http://www.goldeaglewine.com'
    _search_url = 'https://goldeaglewine.com/shop?ch-query={query}'
