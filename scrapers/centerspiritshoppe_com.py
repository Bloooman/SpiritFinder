...
class CenterspiritshoppeComScraper(StoreScraper):
    name = 'Center Spirit Shoppe, CT'
    _base = 'https://centerspiritshoppe.com'
    _search_url = 'https://centerspiritshoppe.com/shop?ch-query={query}'
