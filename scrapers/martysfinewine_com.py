...
class MartysfinewineComScraper(StoreScraper):
    name = "Marty's Fine Wines, MA"
    _base = 'http://www.martysfinewine.com'
    _search_url = 'https://martysfinewine.com/shop?ch-query={query}'
