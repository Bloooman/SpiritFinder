...
class RocktonspiritsComScraper(StoreScraper):
    name = 'Rockton Food & Spirits Rockton IL'
    _base = 'https://rocktonspirits.com'
    _search_url = 'https://rocktonspirits.com/shop?ch-query={query}'
