...
class DdsmokespiritsComScraper(StoreScraper):
    name = 'D&D Smoke & Spirits, IL'
    _base = 'http://ddsmokespirits.com'
    _search_url = 'https://ddsmokespirits.com/shop?ch-query={query}'
