...
class WorldwidebevComScraper(StoreScraper):
    name = 'Worldwide Wine & Spirits, CT'
    _base = 'https://worldwidebev.com'
    _search_url = 'https://www.worldwidebev.com/shop?ch-query={query}'
