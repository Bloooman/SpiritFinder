...
class AandsbeveragesdeliveryComScraper(StoreScraper):
    name = 'A&S Beverages Wine & Spirits, IL'
    _base = 'https://www.aandsbeveragesdelivery.com'
    _search_url = 'https://www.aandsbeveragesdelivery.com/shop?ch-query={query}'
