...
class RoyalfoodliquorComScraper(StoreScraper):
    name = 'Royal Food & Liquor, IL'
    _base = 'http://www.royalfoodliquor.com'
    _search_url = 'https://royalfoodliquor.com/shop?ch-query={query}'
