...
class BurlingtonspiritComScraper(StoreScraper):
    name = 'Burlington Spirits Shoppe, CT'
    _base = 'http://burlingtonspirit.com'
    _search_url = 'https://burlingtonspirit.com/shop?ch-query={query}'
